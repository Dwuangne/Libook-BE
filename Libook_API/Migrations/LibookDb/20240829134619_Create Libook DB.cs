...
{
    /// <inheritdoc />
    public partial class CreateLibookDB : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrecentDiscount = table.Column<float>(type: "real", nullable: false),
                    Remain = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VoucherActiveds", x => new { x.VoucherId, x.UserId });
                    table.ForeignKey(
                        name: "FK_VoucherActiveds_Vouchers_VoucherId",
                        column: x => x.VoucherId,
                        principalTable: "Vouchers",
                        principalColumn: "VoucherId",
                        onDelete: ReferentialAction.Cascade);
